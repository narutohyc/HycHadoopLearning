...
public class MR2 {
    //输入相对路径
    private static String inPath = "/user/hyc/contentcf/contentcf_input2";
    //输出相对路径
    private static String outPath = "/user/hyc/contentcf/contentcf_output2";
    //将step1输出的转置矩阵作为全局缓存
    private static String cache = "/user/hyc/contentcf/contentcf_output1/part-r-00000";
