...
public class MR5 {
    ...
    //输入相对路径
    private static String inPath = "/user/hyc/itemcf/itemcf_output4";
    //输出相对路径
    private static String outPath = "/user/hyc/itemcf/itemcf_output5";
    //将step1输出的转置矩阵作为全局缓存
    ...
    public int run () {
        try {
            ...
            job.addCacheFile(new URI(cache + "#itemUserScore55"));
